...
- Name: Gallery Page Tests >> should have centered navigation links in navbar
- Location: /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:88:7
...
Locator: locator('nav a:has-text("Home")')
Expected: visible
...
Call log:
  ...
  - waiting for locator('nav a:has-text("Home")')
    ...
    at /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:96:69
```
