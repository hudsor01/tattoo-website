...
- Name: Gallery Page Tests >> should verify all expected images are present
- Location: /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:46:7
...
Call log:
  - waiting for locator('img[src*="/images/"]') to be visible
    - waiting for" http://localhost:3001/gallery" navigation to finish...
    - navigated to "http://localhost:3001/gallery"

    at /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:48:16
```
