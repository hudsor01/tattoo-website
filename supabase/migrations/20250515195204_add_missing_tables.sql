...
CREATE TABLE IF NOT EXISTS "_CustomerToTag" (
  "A" UUID NOT NULL,
  "B" UUID NOT NULL,
  CONSTRAINT "_CustomerToTag_A_fkey" FOREIGN KEY ("A") REFERENCES "Customer"("id") ON DELETE CASCADE,
  CONSTRAINT "_CustomerToTag_B_fkey" FOREIGN KEY ("B") REFERENCES "Tag"("id") ON DELETE CASCADE
);
...
-- Create lead, contact, and testimonial tables
...
-- Create indices for email tables
