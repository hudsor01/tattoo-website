...
export const services: Service[] = [
  {
    ...
    shortDescription:
      'Unique, personalized tattoo designs created collaboratively with you to bring your vision to life with precision and artistry.',
    features: [
    ...
    detailedProcess: [
      {
        title: 'Consultation',
        description:
          'We begin with an in-depth discussion about your tattoo idea, exploring themes, symbolism, and personal meaning to ensure your vision is fully understood.',
      },
      {
        title: 'Design Development',
        description:
          'I create custom sketches based on our consultation, refining the artwork through feedback to ensure it perfectly captures your vision before the tattoo session.',
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      'Realistic portrait tattoos that capture the essence and detail of your loved ones, celebrities, or other meaningful subjects.',
    features: [
    ...
    detailedProcess: [
      {
        ...
        description:
          'We carefully select the ideal reference photo that captures the essence and details that make your subject special and will translate well to skin.',
      },
      {
        title: 'Portrait Technique',
        description:
          'Using specialized shading techniques and meticulous attention to detail, I create realistic portraits with proper depth, contrast, and likeness.',
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      'Intricate designs with clean lines and meticulous attention to detail, perfect for minimalist tattoos or complex geometric patterns.',
    features: [
      'Precision line work',
      'Minimalist designs',
      'Geometric patterns',
    ...
    detailedProcess: [
      {
        ...
        description:
          'I use specialized needles and techniques to create exceptionally fine, precise lines with consistent flow and minimal spreading over time.',
      },
      {
        title: 'Design Longevity',
        description:
          'Every fine line design is created with careful consideration of how the tattoo will age, ensuring beautiful results both immediately and years later.',
      },
    ],
  ...
  },
  {
    ...
    shortDescription:
      'Transform or refresh existing tattoos with expert cover-ups or creative reworks that breathe new life into old art.',
    features: [
    ...
    detailedProcess: [
      {
        ...
        description:
          "I thoroughly analyze your existing tattoo's ink density, age, and characteristics to determine the best approach for effective concealment or transformation.",
      },
      {
        title: 'Strategic Design',
        description:
          'Cover-up designs incorporate specific techniques like strategic shading and color theory to effectively integrate or conceal the original tattoo.',
      },
    ],
