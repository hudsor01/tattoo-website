        ...
        <SignIn 
          ...
          appearance={{
            ...
            elements: {
              ...
              socialButtonsBlockButton: 'bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-500 hover:to-orange-400 !text-white font-semibold py-4 px-6 text-lg rounded-xl transition-all duration-200 ease-in-out transform hover:scale-[1.02]',
              socialButtonsBlockButtonText: '!text-white font-semibold text-lg [&>*]:!text-white',
              formFieldInput: 'bg-zinc-800/70 border-2 border-zinc-600/50 focus:border-red-500 text-white py-4 px-4 text-lg rounded-xl transition-colors duration-200',
              formFieldLabel: 'text-zinc-300 text-lg font-semibold mb-2',
              formButtonPrimary: 'bg-gradient-to-r from-red-600 to-orange-500 hover:from-red-500 hover:to-orange-400 py-4 px-6 text-lg font-bold rounded-xl transition-all duration-200 ease-in-out transform hover:scale-[1.02] text-white',
