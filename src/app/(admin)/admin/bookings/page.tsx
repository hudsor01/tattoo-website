...
import VirtualizedBookingsListInfinite from '@/components/admin/VirtualizedBookingsListInfinite';
...
export default function BookingsPage() {
  ...
  return (
    <div className="p-6 bg-gray-950 min-h-screen">
      ...
      {/* Infinite Scroll Bookings List */}
      <VirtualizedBookingsListInfinite defaultStatus={getStatusFilter()} containerHeight={650} />
          ...
          <DialogContent className="max-w-3xl">
            ...
            <DialogFooter>
              ...
              <Button
                onClick={() => {
                  setDialogOpen(false);
                  router.push(`/admin/appointments/create?bookingId=${selectedBooking.id}`);
                }}
              >
