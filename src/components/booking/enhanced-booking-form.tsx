...
/**
 * Enhanced Booking Form Component with standardized error handling and toast notifications
 */
function BookingFormContent() {
  ...
  const form = useForm<BookingFormValues>({
    ...
    onSubmit: withErrorHandling(async (values) => {
      // Show loading toast
      ...
      toast.operationSuccess('Booking submitted successfully!');
  ...
  React.useEffect(() => {
    if (form.values.size && form.values.placement && form.touched.size && form.touched.placement) {
      try {
        ...
        handleError(error, { action: 'calculate-pricing' });
      }
    }
  }, [form.values.size, form.values.placement, form.touched.size, form.touched.placement, calculatePricing, handleError]);
...
/**
 * Enhanced Booking Form with error boundary
 */
export function EnhancedBookingForm() {
  return (
    <EnhancedErrorBoundary
      ...
      description="We're having trouble displaying the booking form. Please try again later or contact us directly."
      showToast={true}
      severity={ErrorSeverity.HIGH}
    >
      <BookingFormContent />
