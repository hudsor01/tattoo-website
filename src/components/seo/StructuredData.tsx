...
const businessInfo: BusinessInfo = {
  ...
  description: "Professional custom tattoo artist specializing in traditional, realism, fine line, and cover-up tattoos in Dallas Fort Worth area.",
  address: {
...
export function LocalBusinessStructuredData() {
  const structuredData = {
    ...
    "sameAs": [
      "https://instagram.com/ink37tattoo",
      "https://facebook.com/ink37tattoo"
    ]
  }
...
export function ArtistStructuredData() {
  const artistData = {
    ...
    "description": "Experienced tattoo artist specializing in custom designs, traditional, realism, and fine line tattoos in Dallas Fort Worth area.",
...
export function GalleryStructuredData({ images }: { images: Array<{ id: string, name: string, category: string, imageUrl: string }> }) {
  const galleryData = {
    "@context": "https://schema.org",
    "@type": "ImageGallery",
    "name": "Ink37 Tattoo Gallery",
    "description": "Professional tattoo artwork gallery featuring custom designs, traditional, realism, and fine line tattoos by Fernando Govea",
    "author": {
      "@type": "Person",
      "name": "Fernando Govea",
      "jobTitle": "Professional Tattoo Artist"
...
export function ServicePageStructuredData({ serviceName, description }: { serviceName: string, description: string }) {
  const serviceData = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": serviceName,
