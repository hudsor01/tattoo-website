...
- Name: Admin Dashboard with Simplified Layout >> admin dashboard should handle responsive layout
- Location: /Users/richard/Developer/tattoo-website/tests/admin-layout-simplified.spec.ts:48:7
...
Call log:
  - navigating to "http://localhost:3002/admin", waiting until "load"
    ...
    at /Users/richard/Developer/tattoo-website/tests/admin-layout-simplified.spec.ts:51:16
```
