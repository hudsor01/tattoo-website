...
Expected string: "http://localhost:3001/booking"
Received string: "http://localhost:3001/gallery"
Call log:
  - expect.toHaveURL with timeout 5000ms
  - waiting for locator(':root')
    9 × locator resolved to <html lang="en" data-theme="dark" class="__variable_e8ce0c __variable_4bc053 __variable_5f64cf __variable_8b8a99 dark">…</html>
      - unexpected value "http://localhost:3001/gallery"

    at /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:144:24
```
