...
- Name: Gallery Page Tests >> should load gallery page with all content
- Location: /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:8:7

# Error details

```
Error: expect.toContainText: Error: strict mode violation: locator('p') resolved to 2 elements:
    1) <p class="text-muted-foreground text-lg max-w-2xl mx-auto mb-10 leading-relaxed">Browse our collection of custom tattoo designs sh…</p> aka getByText('Browse our collection of')
    2) <p class="text-muted-foreground">Let's create your custom tattoo. Book a free cons…</p> aka getByText('Let\'s create your custom')

Call log:
  - expect.toContainText with timeout 5000ms
  - waiting for locator('p')

    at /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:14:37
```
