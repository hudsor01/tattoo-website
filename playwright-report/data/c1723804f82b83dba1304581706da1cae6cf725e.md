...
- Name: Admin Dashboard >> should show login form to unauthenticated users
- Location: /Users/richard/Developer/tattoo-website/tests/admin-dashboard.spec.ts:12:7
...
Call log:
  - navigating to "http://localhost:3002/admin", waiting until "load"
    ...
    at /Users/richard/Developer/tattoo-website/tests/admin-dashboard.spec.ts:13:16
```
