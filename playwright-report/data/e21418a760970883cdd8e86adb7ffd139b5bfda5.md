...
- Name: Admin Dashboard >> should display Cal.com analytics when authenticated
- Location: /Users/richard/Developer/tattoo-website/tests/admin-dashboard.spec.ts:54:7
...
Call log:
  - navigating to "http://localhost:3002/admin", waiting until "load"
    ...
    at /Users/richard/Developer/tattoo-website/tests/admin-dashboard.spec.ts:56:16
```
...
>  56 |     await page.goto('/admin');
  ...
  129 |   //   await page.screenshot({ path: 'cal-analytics-error.png' });
  130 |   // });
  131 | });
```