...
- Name: Gallery Page Tests >> should display all gallery items without filtering system
- Location: /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:17:7
...
Call log:
  ...
  - waiting for locator('[class*="grid"] > div')
    2 × locator resolved to 0 elements
      - unexpected value "0"
    2 × locator resolved to 12 elements
      - unexpected value "12"
    - locator resolved to 0 elements
    - unexpected value "0"
    4 × locator resolved to 13 elements
      - unexpected value "13"

    at /Users/richard/Developer/tattoo-website/tests/gallery.spec.ts:32:32
```
