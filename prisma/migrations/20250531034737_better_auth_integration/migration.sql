...
-- CreateEnum
CREATE TYPE "NoteType" AS ENUM ('MANUAL', 'SYSTEM', 'APPOINTMENT', 'BOOKING', 'PAYMENT', 'INTERACTION', 'FOLLOW_UP');

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'ARTIST', 'ADMIN', 'SUPERADMIN');
...
CREATE TABLE "Note" (
    ...
    "type" "NoteType" NOT NULL DEFAULT 'MANUAL',
